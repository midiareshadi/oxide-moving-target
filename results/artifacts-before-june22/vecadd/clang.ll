; ModuleID = 'kernels/vecadd/cuda/vecadd.cu'
source_filename = "kernels/vecadd/cuda/vecadd.cu"
target datalayout = "e-p6:32:32-i64:64-i128:128-v16:16-v32:32-n16:32:64"
target triple = "nvptx64-nvidia-cuda"

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind willreturn memory(argmem: readwrite)
define dso_local ptx_kernel void @vecadd(ptr noundef readonly captures(none) %0, ptr noundef readonly captures(none) %1, ptr noundef writeonly captures(none) %2, i32 noundef %3) local_unnamed_addr #0 {
...
11:                                               ; preds = %4
  ...
  %17 = load float, ptr %14, align 4, !tbaa !7
  %18 = fadd contract float %16, %17
  store float %18, ptr %13, align 4, !tbaa !7
  br label %19
